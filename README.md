<p align="center">
	<a href="https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc"><img src="https://user-images.githubusercontent.com/1128849/49704830-49d37200-fbd5-11e8-8385-767e0cd033c3.png" alt="CertMagic" width="550"></a>
</p>
<h3 align="center">Easy and Powerful TLS Automation</h3>
<p align="center">The same library used by the <a href="https://tmpim.com">Caddy Web Server</a></p>
<p align="center">
	<a href="https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc"><img src="https://img.shields.io/badge/godoc-reference-blue.svg"></a>
	<a href="https://github.com/tmpim/certmagic/actions?query=workflow%3ATests"><img src="https://github.com/tmpim/certmagic/workflows/Tests/badge.svg"></a>
	<a href="https://sourcegraph.com/github.com/tmpim/certmagic?badge"><img src="https://sourcegraph.com/github.com/tmpim/certmagic/-/badge.svg"></a>
</p>
...
```bash
$ go get github.com/tmpim/certmagic
```
...
See [Storage](#storage) and the associated [pkg.go.dev](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#Storage) for more information!
...
The [pkg.go.dev](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#OnDemandConfig) describes how to use this in full detail, so please check it out!
...
The easiest way to change the storage being used is to set `certmagic.DefaultStorage` to a value that satisfies the [Storage interface](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#Storage). Keep in mind that a valid `Storage` must be able to implement some operations atomically in order to provide locking and synchronization.

If you write a Storage implementation, please add it to the [project wiki](https://github.com/tmpim/certmagic/wiki/Storage-Implementations) so people can find it!
...
- [`CacheUnmanagedCertificatePEMBytes()`](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#Config.CacheUnmanagedCertificatePEMBytes)
- [`CacheUnmanagedCertificatePEMFile()`](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#Config.CacheUnmanagedCertificatePEMFile)
- [`CacheUnmanagedTLSCertificate()`](https://pkg.go.dev/github.com/tmpim/certmagic?tab=doc#Config.CacheUnmanagedTLSCertificate)
...
We welcome your contributions! Please see our **[contributing guidelines](https://github.com/tmpim/certmagic/blob/master/.github/CONTRIBUTING.md)** for instructions.
